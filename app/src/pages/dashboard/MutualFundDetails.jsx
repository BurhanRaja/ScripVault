        ...
        <div className='flex justify-between my-5 px-5'>
          ...
          <div className='w-[48%] text-end'>
            <div className='flex justify-end items-center'>
              {!priceData && isLoading ? <span className='w-1/2 p-7 mb-3 h-5 block rounded bg-gray-200 animate-pulse'></span> : <h2 className='text-3xl font-bold mb-2 me-3'>
                ₹ {priceData?.curr_price}
              </h2>}

              {!priceData && isLoading ? <span className='w-1/2 p-7 mb-3 h-5 block rounded bg-gray-200 animate-pulse'></span> : priceData?.price_change > 0 ? (
            ...
            <button className='w-full px-4 py-2 lg:mt-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-600 rounded-md sm:mt-0 sm:w-1/2 sm:mx-2 hover:bg-green-700 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40'>
              Buy Now
            </button>
          </div>
        </div>
        ...
        <div className='flex justify-between'>
          <div className='w-[49%]'>
            <div className='bg-white p-5 my-3'>
              ...
              {!detailsData && isLoading ? <><span className='w-full p-7 mb-3 h-5 block rounded bg-gray-200 animate-pulse'></span><span className='w-full p-7 mb-3 h-5 block rounded bg-gray-200 animate-pulse'></span></> : <div className=''>
                {detailsData?.holding_info?.portfolioComposition?.map((el) => {
                  return (
          ...
          <div className='w-[49%]'>
            <div className='bg-white p-5 my-3'>
              ...
              {!detailsData && isLoading ? <><span className='w-full p-7 mb-3 h-5 block rounded bg-gray-200 animate-pulse'></span>
              <span className='w-full p-7 mb-3 h-5 block rounded bg-gray-200 animate-pulse'></span></> : <div className=''>
